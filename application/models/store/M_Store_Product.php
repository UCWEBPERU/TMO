...
class M_Store_Product extends CI_Model {
    ...
    public function getModifiers($data) {
        ...
        $this->db->order_by('Modificador_Productos.tipo_modificador asc, Detalle_Modificador_Productos.descripcion_modificador asc');
