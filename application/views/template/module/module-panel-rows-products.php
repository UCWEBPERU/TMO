<?php if (is_array($modulo->registros)) {
	...
	<td><span class="label label-success"><?php echo $modeloRow->nombre_categoria; ?></span></td>
    <td><span class="label label-success"><?php echo $modeloRow->nombre_sub_categoria; ?></span></td>
	<td>
