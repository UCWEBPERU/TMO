<?php if (is_array($modulo->registros)) {
    ...
    foreach ($modulo->registros as $modeloRow) { ?>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo $modulo->url_module_panel."/edit/".intval($modeloRow->id_tienda) ?>" data-row-type="store" data-row-action="edit" data-row-id="<?php echo $modeloRow->id_tienda; ?>" class="btnActionRow"><span class="label label-primary">Editar</span></a>&nbsp;&nbsp;
