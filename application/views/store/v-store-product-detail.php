            ...
            <div class="content-modifier">
                ...
                foreach ($modulo->data_modifiers as $modifier) { ?>
                    <?php if (trim(strtolower($modifier->tipo_modificador)) == "color") { ?>
                        ...
                        <?php }else{ ?>
                            <div class="item-modifier btnAddModifier" style="border:2px solid white ;background: <?php echo $modifier->color_rgb; ?>;" data-id-modifier="<?php echo ucwords($modifier->id_modificador_productos); ?>" data-type-modifier="<?php echo ucwords($modifier->tipo_modificador); ?>"><?php echo $modifier->descripcion_modificador; ?></div>
                        <?php } } ?>
                    <?php } ?>
                <?php $index++; } ?>
            </div>
...
<script>
    ...
    $(".btnAddModifier").on("click", function (e){
        e.preventDefault();
        $(".btnAddModifier").parent().children().css("border-color", "white" );
