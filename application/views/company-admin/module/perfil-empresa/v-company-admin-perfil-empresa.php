                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-logo-store">
                                            <div class="avatar-uploader-inner" style=" overflow: hidden; width: 256px; height: 256px; background-image:url(&quot;<?php echo $modulo->icono_empresa; ?>&quot;);" data-reactid=".0.5.$=1$UserSettingsModal.0.0.1.0.$ACCOUNT.0.1.1.0">
