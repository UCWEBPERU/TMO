...
<script>
    $(function () {
        ...
        $("#btnInputLatitud, #btnInputLongitud").on("click", function() {
            GenericModal.show("default", "<div class='box-flex-center'></div><i class='fa fa-refresh fa-spin'></i><div id='somecomponent' style='min-width: 300px; max-width: 500px; min-height: 300px; max-height: 500px; margin: 0px auto;'></div>");
            setTimeout(function(){
                $.geolocation.get({
