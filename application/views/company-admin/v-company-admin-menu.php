...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li <?php echo ($menu == 4) ? 'class="active"' : ''; ?>><a href="<?php echo $modulo->url_main_panel; ?>/category"><i class="fa fa-tags"></i><span>Category</span></a></li>
			<li <?php echo ($menu == 5) ? 'class="active"' : ''; ?>><a href="<?php echo $modulo->url_main_panel; ?>/user"><i class="fa fa-user"></i><span>User</span></a></li>
		</ul><!-- /.sidebar-menu -->
	</section>
	<!-- /.sidebar -->
</aside>