...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
            ...
            <li <?php echo ($menu == 2) ? 'class="active"' : ''; ?>><a href="admin/tipoempresa"><i class="fa fa-building-o"></i> <span>Business type</span></a></li>
            <li <?php echo ($menu == 3) ? 'class="active"' : ''; ?>><a href="admin/paquetes-tmo"><i class="fa fa-building-o"></i> <span>Paquetes TMO</span></a></li>
