                        ...
                        <form id="frmPerfilUsuario" name="frmPerfilUsuario" role="form" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="txtNombres">First Name</label>
                                ...
                                <div class="form-group">
                                    <label for="txtApellidos">Last Name</label>
                                ...
                                <div class="form-group">
                                    <label for="txtNumeroCelular">Mobile Phone</label>
                                    <input type="text" class="form-control" id="txtNumeroCelular" name="txtNumeroCelular" data-parsley-type="digits" value="<?php echo $modulo->datos_usuario->celular_personal; ?>" data-parsley-required data-parsley-type="integer" data-parsley-required-message="Ingrese su numero de celular." data-parsley-type-message="Ingrese un numero de celular valido."/>
                                </div>
                                <div class="form-group">
                                    <label for="txtNumeroCelular">Home Phone</label>
                                    <input type="text" class="form-control" id="txtNumeroCelular" name="txtNumeroCelular" data-parsley-type="digits" value="<?php echo $modulo->datos_usuario->telefono; ?>" data-parsley-required data-parsley-type="integer" data-parsley-required-message="Ingrese su numero de celular." data-parsley-type-message="Ingrese un numero de celular valido."/>
                                </div>
                                <div class="form-group">
                                    <label for="txtNumeroCelular">Work Phone</label>
                                    <input type="text" class="form-control" id="txtNumeroCelular" name="txtNumeroCelular" data-parsley-type="digits" value="<?php echo $modulo->datos_usuario->celular_trabajo; ?>" data-parsley-required data-parsley-type="integer" data-parsley-required-message="Ingrese su numero de celular." data-parsley-type-message="Ingrese un numero de celular valido."/>
                                </div>
                                <div class="form-group">
                                    <label for="txtPais">Country</label>
                                    <input type="text" class="form-control" id="txtPais" name="txtPais" value="<?php echo $modulo->datos_usuario->pais_persona; ?>" data-parsley-required data-parsley-required-message="Ingrese su pais."/>
                                </div>
                                <div class="form-group">
                                    <label for="txtEstado">State</label>
                                    <input type="text" class="form-control" id="txtEstado" name="txtEstado" value="<?php echo $modulo->datos_usuario->region_persona; ?>" data-parsley-required data-parsley-required-message="Ingrese su estado."/>
                                </div>
                                <div class="form-group">
                                    <label for="txtEstado">City</label>
                                    <input type="text" class="form-control" id="txtEstado" name="txtEstado" value="<?php echo $modulo->datos_usuario->ciudad_persona; ?>" data-parsley-required data-parsley-required-message="Ingrese su estado."/>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="frmDatosUsuario" name="frmDatosUsuario" role="form" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="txtEmailUsuario">User/Email Account</label>
