                        ...
                        <form id="formPaqueteTMO" role="form">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtNombre" name="txtNombre" maxlength="50" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>" data-parsley-required data-parsley-required-message="Ingrese nombre del paquete.">
                                    <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtDescripcion" name="txtDescripcion" maxlength="150" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>">
                                    <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtTotalTiendas" name="txtTotalTiendas" maxlength="5" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>" data-parsley-required data-parsley-type="number" data-parsley-required-message="Ingrese total de tiendas del paquete." data-parsley-required-type=" El total de tiendas solo debe ser numeros.">
                                    <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtTotalProductos" name="txtTotalProductos" maxlength="5" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>" data-parsley-required data-parsley-type="number" data-parsley-required-message="Ingrese total de productos del paquete." data-parsley-required-type=" El total de productos solo debe ser numeros.">
                                    <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtTotalUsuarios" name="txtTotalUsuarios" maxlength="5" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>" data-parsley-required data-parsley-type="number" data-parsley-required-message="Ingrese total de usuarios del paquete." data-parsley-required-type=" El total de usuarios solo debe ser numeros.">
                                    <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtTotalCategorias" name="txtTotalCategorias" maxlength="5" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>" data-parsley-required data-parsley-type="number" data-parsley-required-message="Ingrese total de categorias del paquete." data-parsley-required-type=" El total de categorias solo debe ser numeros.">
                                    <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtTiempoSuscripcion" name="txtTiempoSuscripcion" maxlength="5" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>" data-parsley-required data-parsley-type="number" data-parsley-required-message="Ingrese tiempo de suscripción del paquete." data-parsley-required-type=" El tiempo de suscripcion solo debe ser numeros.">
                                    <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($existePaqueteTMO) { ?>
                                        <input type="text" class="form-control" id="txtPrecio" name="txtPrecio" maxlength="5" value="<?php echo $dataTipo->nombre_tipo_empresa; ?>" data-parsley-required data-parsley-required-message="Ingrese precio del paquete.">
                                    <?php } else { ?>
