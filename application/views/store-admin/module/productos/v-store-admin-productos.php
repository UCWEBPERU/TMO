      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small><a href="<?php echo $modulo->url_main_panel; ?>/products/add">Agregar</a></small>
          </h1>
          <ol class="breadcrumb">
            ...
            <?php foreach ($modulo->navegacion as $navegacion) {
              ...
              <?php } else { 
                      if (strlen($navegacion["url"]) > 0) { ?>
                        <li><a href="<?php echo $modulo->url_main_panel.$navegacion["url"]; ?>"><?php echo $navegacion["nombre"]; ?></a></li>
                <?php } else { ?>
    ...
    <script>
      $(function () {
        ...
        $(".btnActionRow").on("click", function(evt){
          ...
          var baseUrl   = "<?php echo $modulo->url_main_panel; ?>";
          var urlApi    = "";
          ...
          if ( $(this).attr("data-row-action") == "edit") {
            ...
            urlApi = baseUrl + "products/delete";
