...
$route['company/(:num)/store/(:num)/account/orders']         = 'store/C_Store_Account/myOrders';
...
$route['company/(:num)/store/(:num)/promotions/products/(:num)']                    = 'store/C_Store_Product/viewProductPromotions/$3';
